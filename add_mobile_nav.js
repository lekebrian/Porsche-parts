...
const files = [
    ...
    'wheels.html', 'lifestyle.html', 'review.html', 'contactus.html',
    'terms.html', 'shippolicy.html', 'returnpolicy.html'
];
...
files.forEach(file => {
    try {
        ...
        // Add hamburger menu
        content = content.replace('<header class="head-2">', '<header class="head-2">' + hamburgerMenu);
        
        // Add mobile navigation
        content = content.replace('</body>\n</html>', mobileNavStructure);
